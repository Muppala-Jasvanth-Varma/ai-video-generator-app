...
var _XetBlob = class extends Blob {
  constructor(params) {
    ...
    _chunkGBTJQUG5js.__publicField.call(void 0, this, "repoId");
    _chunkGBTJQUG5js.__publicField.call(void 0, this, "hubUrl");
    ...
    this.hubUrl = (_b = params.hubUrl) != null ? _b : HUB_URL;
    this.end = params.size;
    this.hash = params.hash;
    this.listener = params.listener;
    this.internalLogging = (_c = params.internalLogging) != null ? _c : false;
    this.hubUrl;
  }
  get size() {
    return this.end - this.start;
